...
function string.diff(str1, str2)

    -- print('in leven', str1, str2)
    ...
    elseif (len2 == 0) then
        return len1 * x
    elseif (str1:lower() == str2:lower()) then
        return 0
    end
...
local codec = {
    ...
    tr = function(self, seg)
        local s0, n0 = self:match(seg)
        local s = seg:sub(1, 3)
    ...
    init = function(self, faction, oppositeLang)
        ...
        for k, v in pairs(self.set) do self.rset[v] = k end
    end,
